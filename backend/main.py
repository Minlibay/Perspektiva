...
ITEM_RULES = {
    ...
    1: {
        ...
        "extra_instructions": (
            ...
            "Источник может называться «Орг.структура», «Организационная структура» или сокращённо «ОС <Название компании>». "
            "Сопоставь состав/иерархию. OK только если структуры совпадают по существу. "
            "NOK при расхождениях или отсутствии подтверждающего файла."
        ),
    },
    2: {
